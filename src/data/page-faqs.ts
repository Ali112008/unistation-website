...
export const pageFaqs: Record<string, FAQItem[]> = {
  ...
  turkey: [
    { q: "Do I need to speak Turkish to study in Turkey?", a: "Not necessarily. Many Turkish universities offer English-taught programs, especially in fields like Medicine, Engineering, and Business. However, learning Turkish is highly recommended as it enhances daily life, internship opportunities, and career prospects after graduation." },
    { q: "How much does it cost to study in Turkey?", a: "Public university tuition ranges from $500 to $5,000 per year for non-medical programs, and $4,000 to $10,000+ for medical programs. Private universities charge $1,500 to $9,000 per year for non-medical programs and $13,000 to $35,000+ for medical programs." },
    { q: "What are the living costs for international students in Turkey?", a: "Most international students spend between $300 and $1,000 per month depending on the city, accommodation type, and lifestyle. Istanbul tends to be more expensive, while cities like Ankara, Izmir, and Antalya offer significantly lower living costs." },
    { q: "Are Turkish degrees recognized internationally?", a: "Yes. Degrees from accredited Turkish universities are recognized worldwide. Many Turkish universities are ranked internationally and hold partnerships with institutions across Europe, the US, and Asia." },
    { q: "Can I stay in Turkey after graduation?", a: "Yes. International graduates can remain in Turkey through several pathways including obtaining a work permit, continuing postgraduate studies, establishing a business, or transitioning to eligible residence permits." },
    { q: "What are the best cities for international students in Turkey?", a: "Istanbul offers the most university options and a vibrant international lifestyle. Ankara is the capital with prestigious universities and a student-focused environment. Izmir provides a relaxed Mediterranean lifestyle, and Antalya combines beautiful coastline with expanding university options." },
  ],
};